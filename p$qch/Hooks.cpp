...
namespace Hooks {
	...
	void Initialize() {
		...
		SSDK::I::CVar()->ConsoleColorPrintf(SSDK::Color(255, 0, 255), XorStr("\nWelcome to Narcissisti.cc, press Insert for the menu.\n"));
		SSDK::I::CVar()->ConsoleColorPrintf(SSDK::Color(255, 0, 255), XorStr("Any questions? Contact an administrator on the forums!\n"));
		SSDK::I::CVar()->ConsoleColorPrintf(SSDK::Color(255, 0, 255), XorStr("Build Date: 4/25/2017 - 9:00 PM EST\n")); // OH MAN I SURE LIKE PRINTING SHIT 2 CONSOLE
		...
		//CONFIG SAVER - LOAD
		std::ifstream ifs("narcissisticc.save", std::ios::binary);
