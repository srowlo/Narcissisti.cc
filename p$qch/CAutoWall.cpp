...
float CAutowall::BestHitPoint(CBaseEntity* pEntity, int prioritized, float minDmg, SSDK::mstudiohitboxset_t* hitset, SSDK::matrix3x4a_t matrix[], SSDK::Vector& vecOut) {
	...
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	if (pEntity->isDucking())
	vecArray[1].z += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.8f);
	else
	vecArray[1].z += hitbox->m_flRadius * 1.f;
	vecArray[2].y += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[3].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_NECK:
	for (auto i = 0; i < 4; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].z += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[1].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[2].y += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[3].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	...
	vecArray[3].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_UPPER_CHEST:
	for (auto i = 0; i < 4; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[1].y += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[2].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[3].z += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_CHEST:
	for (auto i = 0; i < 4; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	...
	vecArray[3].z += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_THORAX:
	for (auto i = 0; i < 3; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	...
	vecArray[2].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_BODY:
	for (auto i = 0; i < 3; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 1.f);
	vecArray[1].y += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[2].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_LEFT_THIGH:
	for (auto i = 0; i < 2; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[0].y += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	vecArray[1].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_RIGHT_THIGH:
	for (auto i = 0; i < 2; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	...
	vecArray[1].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_LEFT_CALF:
	for (auto i = 0; i < 2; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	...
	vecArray[1].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_RIGHT_CALF:
	for (auto i = 0; i < 2; ++i) {
	vecArray.emplace_back(center);
	}
	vecArray[0].x -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	...
	vecArray[1].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_LEFT_FOOT:
	vecArray.emplace_back(center);
	break;
	case SSDK::HitboxEnum_t::HITBOX_RIGHT_FOOT:
	vecArray.emplace_back(center);
	break;
	case SSDK::HitboxEnum_t::HITBOX_LEFT_FOREARM:
	vecArray.emplace_back(center);

	vecArray[0].y -= hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_RIGHT_FOREARM:
	vecArray.emplace_back(center);

	vecArray[0].y += hitbox->m_flRadius * Utilities::RandomFloat(0.f, 0.9f);
	break;
	case SSDK::HitboxEnum_t::HITBOX_RIGHT_HAND:
	vecArray.emplace_back(center);
	break;
	default:
	return 0.f;
	...
	for (SSDK::Vector cur : vecArray) {
		float flCurDamage = GetDamage(cur);//Invasive(cur);//GetDamage(cur);
